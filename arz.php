...
<title><?php echo $sitetitle;?> - نرخ ارز</title>
...
<div id="main">
	...
	<div class="middle">
    	<div id="content">
			<div class="page">
			<h2>نرخ ارز</h2>
			<p>نرخ رسمی ارز (بانک مرکزی جمهوری اسلامی ایران) به شرح زیر می باشد</p>
			<table id="curr" width="100%">
<?php
$XmlString = retrieve() ;
	$XmlObject = new SimpleXMLElement($XmlString);
	
	$items = (array) $XmlObject->channel;
	...
	<tr>
		<td><?php echo $cur[description]?></td>
	</tr>
